        ...
        <div className="mt-8 rounded-3xl border border-gray-200 bg-white p-8 shadow-lg">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors">
              <div className="flex-shrink-0 w-12 h-12 rounded-full bg-kahra_gold/10 flex items-center justify-center">
                <svg className="w-6 h-6 text-kahra_gold" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  className="text-kahra_gold hover:text-kahra_gold/80 transition-colors text-sm"
                >
                  dotcosoft@gmail.com
                </a>
              </div>
          ...
          <div className="mt-8 p-4 rounded-xl bg-kahra_cream/20 border border-kahra_gold/30">
